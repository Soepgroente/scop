...
{
	elements[0][0] = col0[0]; elements[1][0] = col0[1]; elements[2][0] = col0[2];
	elements[0][1] = col1[0]; elements[1][1] = col1[1]; elements[2][1] = col1[2];
	elements[0][2] = col2[0]; elements[1][2] = col2[1]; elements[2][2] = col2[2];
}
